...
public class SwaggerConfig {
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2)
				...
				.select().apis(RequestHandlerSelectors.basePackage("br.com.calcard"))
				.paths(PathSelectors.any()).build().apiInfo(apiInfo());
	}

	private ApiInfo apiInfo() {
		return new ApiInfoBuilder()
				.title("API Proposta Calcard")
				.description("Esta API é utilizada como documentação")
				.version("1.0.0")
				.contact(new Contact("Felipe Stegel", "https://www.zallpy.com", "felipe.stegel@zallpy.com"))
				.license("Permitido uso para membros do time Calcard")
				.licenseUrl("https://www.calcard.com")
				.build();
